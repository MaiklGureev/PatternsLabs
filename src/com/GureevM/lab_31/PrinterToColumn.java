...
public class PrinterToColumn implements ChainOfResponsibility {

    ChainOfResponsibility nextInChain;
    ...
    private void write(Transport transport) {
        try (FileWriter writer = new FileWriter("src/com/GureevM/lab_31/outputFileToColumn.txt", false)) {
